...
PLANS = [
    {
        ...
        "category": "exercise",
        "description": (
            "A progressive 12-week barbell program to build raw, "
            "full-body strength."
        ),
        "price": Decimal("49.00"),
        "premium_only": False,
    },
    {
        ...
        "category": "exercise",
        "description": (
            "Advanced high-volume training for serious muscle growth. "
    ...
    },
    {
        ...
        "category": "nutrition",
        "description": (
            "A flexible meal-planning system to lose "
            "fat without giving up the foods you love."
        ),
        "price": Decimal("39.00"),
        "premium_only": False,
    },
...
PRODUCTS = [{"slug": "resistance-bands-set",
             "name": "Resistance Bands Set",
             "category": "exercise",
             "description": (
                 "Five premium latex resistance bands "
                 "with carry bag — train anywhere."
             ),
             "price": Decimal("29.00"),
             "stock": 25,
             },
            {"slug": "whey-protein-1kg",
             ...
             "category": "nutrition",
             "description": (
                 "Grass-fed whey isolate, 25g protein per serving. "
                 "Currently sold out."
             ),
             "price": Decimal("34.00"),
             "stock": 0,
            ...
            {"slug": "pulsefit-training-tee",
             ...
             "category": "merch",
             "description": (
                 "Breathable performance tee with the PulseFit logo."
             ),
             "price": Decimal("25.00"),
             "stock": 12,
             },
...
class Command(BaseCommand):
    help = (
        "Seed the catalog with sample plans "
        "and products (dev only, idempotent)."
    )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Catalog seeded: +{plans_created} plans, "
                f"+{products_created} products (categories ensured). "
